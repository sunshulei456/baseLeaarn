...
public class PayContractTransfornUser {
	public ITipMessagePayload modify(ITipMessagePayload inMessage) throws Exception {
		...
		Node node = document.selectSingleNode("//soapenv:Body/irec:recvPayContract");
		...
		String pmsUser = (String) childJsonObject.get("def2");
	    ...
	    childJsonObject.put("def2", ncUser);
